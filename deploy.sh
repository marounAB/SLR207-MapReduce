...
fileExtension=".java"
computers=("tp-1a201-04.enst.fr" "tp-1a201-01.enst.fr" "tp-1a201-02.enst.fr" "tp-1a201-03.enst.fr" "tp-1a201-05.enst.fr" "tp-1a201-06.enst.fr" "tp-1a201-08.enst.fr" "tp-1a201-09.enst.fr" "tp-1a201-10.enst.fr" "tp-1a201-11.enst.fr" "tp-1a201-12.enst.fr" "tp-1a201-13.enst.fr")
...
for c in ${computers[@]}; do
  ...
  command3=("ssh" "$login@$c" "cd $remoteFolder;javac $fileName$fileExtension;java -Xmx8g $fileName")
  echo ${command0[*]}
  "${command0[@]}"
  echo ${command1[*]}
  "${command1[@]}"
